...
class SimclrLoss(nn.Module):
    def __init__(self, cfg, is_bassl):
        ...
        #self.head_nce = MlpHead(input_dim=768)

        #self.head_nce_place = MlpHead(**nce_cfg["head"])
        #self.head_nce_place = MlpHead(input_dim=90, hidden_dim=512, output_dim=128)   #audio

        #self.dtw_head = nn.Linear(256, 128)
    ...
    def __init__(self, cfg):
        ...
        if self.use_crn:
            ...
            assert (
                ...
                #and (not self.use_pp_loss)  #later
