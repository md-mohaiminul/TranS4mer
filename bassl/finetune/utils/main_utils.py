...
def init_model(cfg, cfg2=None):
    ...
    if "LOAD_FROM" in cfg and len(cfg.LOAD_FROM) > 0:
        ...
        print("LOAD FINETUNED MODEL WEIGHTS FROM: ", cfg.FINETUNED_LOAD_FROM)
        model = FinetuningWrapper.load_from_checkpoint(
            cfg=cfg,
            shot_encoder=shot_encoder,
            crn=crn,
            # checkpoint_path="/playpen-storage/mmiemon/MovieNet/bassl/bassl/"
            #                 "finetune/ckpt/bassl_vit_small_joint_batch_72/model-v1.ckpt",
